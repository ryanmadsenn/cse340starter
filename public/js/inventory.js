...
function buildInventoryList(data) {
  ...
  data.forEach(function (element) {
    ...
    dataTable += `<td><a class="vehicle-table-button" href='/inv/edit/${element.inv_id}' title='Click to update'>Modify</a></td>`;
    dataTable += `<td><a class="vehicle-table-button" href='/inv/delete/${element.inv_id}' title='Click to delete'>Delete</a></td></tr>`;
  });
  dataTable += "</tbody>";
...
function buildEmptyTable() {
  ...
  dataTable += "<tbody>";
  dataTable +=
    "<tr><td colspan='3'>No vehicles found for classification</td></tr>";
  dataTable += "</tbody>";
